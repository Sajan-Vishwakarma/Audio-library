...
if (isset($_SESSION['adminname']) && $_SESSION['loggedinadmin'] == TRUE) {
    ...
    if (isset($_POST['submit']) && $_POST['submit']) {
        ...
        if ($call == "Add-Album") {
            ...
            $insert = "INSERT INTO Album (album_title,artist_id) VALUES ('$album_title','$artist_id')";
            $result = mysqli_query($link, $insert);
        ...
        if ($call == "Add-Track") {
            ...
            $insert = "INSERT INTO Track (songname,album_id,genre_id,likes) 
                    VALUES ('$songname','$album_id','$gid',0)";
            $result = mysqli_query($link, $insert);
